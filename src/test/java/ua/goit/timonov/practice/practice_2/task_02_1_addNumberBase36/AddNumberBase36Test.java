...
/**
 * Testing class for AddNumberBase36
 */
public class AddNumberBase36Test {
    AddNumberBase36 sumCalc = new AddNumberBase36Validator(new AddNumberBase36());
    ...
    public void testAddNormal_1() {
        ...
        String adderB = "1";
        String expected = "a";
        String actual = sumCalc.add(adderA, adderB);
